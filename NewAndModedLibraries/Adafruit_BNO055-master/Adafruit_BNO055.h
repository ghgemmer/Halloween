...
#error "On an arduino Zero, BNO055's ADR pin must be high. Fix that, then delete this line."
  ...
  protected:
    virtual byte  read8   ( adafruit_bno055_reg_t );
    virtual bool  readLen ( adafruit_bno055_reg_t, byte* buffer, uint8_t len );
    virtual bool  write8  ( adafruit_bno055_reg_t, byte value );
