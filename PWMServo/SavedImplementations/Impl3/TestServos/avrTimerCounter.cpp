...
const avrTimerCounter::HdwrBitDef avrTimerCounter::TimerHdwrBitDefsTable[MAX_NUM_TIMER_BITDEFS] =
...
bool avrTimerCounter::setCompareOutputMode(channelDef channel,compareOutputModeDef mode )
{
  ...
  {
  	ok = true;
		uint8_t com0BitMsk = TimerHdwrBitDefsTable[bitDefsIndex].com0BitMsk[(unsigned int)channel];
		uint8_t com1BitMsk = TimerHdwrBitDefsTable[bitDefsIndex].com1BitMsk[(unsigned int)channel];
...
{
	uint8_t wgm0BitMsk = TimerHdwrBitDefsTable[bitDefsIndex].wgm0BitMsk;
	uint8_t wgm1BitMsk = TimerHdwrBitDefsTable[bitDefsIndex].wgm1BitMsk;
	uint8_t wgm2BitMsk = TimerHdwrBitDefsTable[bitDefsIndex].wgm2BitMsk;
	uint8_t wgm3BitMsk = TimerHdwrBitDefsTable[bitDefsIndex].wgm3BitMsk;
	volatile uint8_t * tccrA = TimerHdwrCntrlInfo[timerIndex].tccrA;
...
{
	uint8_t icncBitMsk = TimerHdwrBitDefsTable[bitDefsIndex].icncBitMsk;
	volatile uint8_t * tccrB = TimerHdwrCntrlInfo[timerIndex].tccrB;
...
{
	uint8_t icesBitMsk = TimerHdwrBitDefsTable[bitDefsIndex].icesBitMsk;
	volatile uint8_t * tccrB = TimerHdwrCntrlInfo[timerIndex].tccrB;
...
{
	uint8_t cs0BitMsk = TimerHdwrBitDefsTable[bitDefsIndex].cs0BitMsk;
	uint8_t cs1BitMsk = TimerHdwrBitDefsTable[bitDefsIndex].cs1BitMsk;
	uint8_t cs2BitMsk = TimerHdwrBitDefsTable[bitDefsIndex].cs2BitMsk;
	volatile uint8_t * tccrB = TimerHdwrCntrlInfo[timerIndex].tccrB;
...
//  {
//  	ok = true;
//		uint8_t focBitMsk = TimerHdwrBitDefsTable[bitDefsIndex].focBitMsk[(unsigned int)channel];
...
{
	uint8_t icieBitMsk = TimerHdwrBitDefsTable[bitDefsIndex].icieBitMsk;
	volatile uint8_t * timsk = TimerHdwrCntrlInfo[timerIndex].timsk;
...
bool avrTimerCounter::setOutputCompareIntEnable(channelDef channel, bool enable)
{
  ...
  {
  	ok = true;
		uint8_t ocieBitMsk = TimerHdwrBitDefsTable[bitDefsIndex].ocieBitMsk[(unsigned int)channel];
		volatile uint8_t * timsk = TimerHdwrCntrlInfo[timerIndex].timsk;
...
{
	uint8_t toieBitMsk = TimerHdwrBitDefsTable[bitDefsIndex].toieBitMsk;
	volatile uint8_t * timsk = TimerHdwrCntrlInfo[timerIndex].timsk;
...
void avrTimerCounter::printHdwrCntrlInfo()
{
	...
	HdwrCntrlInfoDef info = TimerHdwrCntrlInfo[timerIndex];
	HdwrBitDef bitInfo = TimerHdwrBitDefsTable[bitDefsIndex];
